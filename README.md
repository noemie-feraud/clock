...
- affiche l’heure au format **hh:mm:ss** et s’actualise **toutes les secondes** jusqu’à l’arrêt du programme, :contentReference[oaicite:2]{index=2}
- permet de **régler/afficher une heure** à partir d’un tuple **(heures, minutes, secondes)** via une fonction dédiée, :contentReference[oaicite:3]{index=3}
- permet de **régler une alarme** (tuple) et d’afficher un message lorsque l’heure courante correspond à l’alarme. :contentReference[oaicite:4]{index=4}

Bonus implémentés :
- affichage **12h / 24h** avec **AM/PM** en mode 12h, :contentReference[oaicite:5]{index=5}
- **pause** de l’horloge (suspension de l’actualisation jusqu’à reprise). :contentReference[oaicite:6]{index=6}
